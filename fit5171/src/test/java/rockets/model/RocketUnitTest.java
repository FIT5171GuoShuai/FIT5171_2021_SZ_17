...
//    @DisplayName("should throw exception when pass a empty string as massToLEO to setMassToLEO function")
//    @ParameterizedTest
//    @ValueSource(strings = {"", " ", "  "})
...
//    @DisplayName("should throw exception when pass a empty string as massToGTO to setMassToGTO function")
//    @ParameterizedTest
//    @ValueSource(strings = {"", " ", "  "})
...
//    @DisplayName("should throw exception when pass a empty string as massToOther to setMassToOther function")
//    @ParameterizedTest
//    @ValueSource(strings = {"", " ", "  "})
